...
class Correlation101AlphaModel(AlphaModel):
    def __init__(self, resolution = Resolution.Daily, n_alphas = [-1], lookback = 30, top=3):
        self.Name = "Correlation101AlphaModel"
        self.resolution = resolution
        self.n_alphas = n_alphas        # [-1] Takes all alphas
        self.lookback = lookback
        self.top = 3
        self.prev_date = None

    def Update(self, algorithm, data):
        #Request historical data required for the alpha 003 calculation
        self.dataframe = algorithm.History(algorithm.Symbol("SPY"), self.lookback, self.resolution)
        self.dataframe = self.dataframe.loc["SPY"]
        
        #Check if data is not empty
        if self.dataframe.empty:
            algorithm.Debug("[Alpha] - Empty dataframe")
            return
        
        self.current_date = algorithm.Time.date()
        algorithm.Debug(str(self.current_date))
        if self.current_date != self.prev_date:
            algorithm.Debug("[Alpha] - New day")
            #Generate new column
            self.dataframe['Simple Return'] = self.dataframe['close'] / self.dataframe['close'].shift(1) - 1
            self.dataframe = self.dataframe.fillna(0)
            algorithm.Debug(str(self.dataframe['close']))
            self.getAlpha(algorithm)
            
            #Ahora miramos la correlacion por la ventana escogida
            corr_list = get_corr(self.dataframe, self.lookback, self.top)
            signals = get_signal(self.dataframe, corr_list, self.top)
            
            buy_signal_price = signals[0]
            sell_signal_price = signals[1]
            
            direction = InsightDirection.Flat
            if np.isnan(buy_signal_price) and np.isnan(sell_signal_price):
                direction = InsightDirection.Flat
            elif not np.isnan(sell_signal_price):
                direction = InsightDirection.Down
                algorithm.Debug("[Alpha] - Down")
            else:
                direction = InsightDirection.Up
                algorithm.Debug("[Alpha] - Up")
                
            if direction == InsightDirection.Flat:
                algorithm.Debug("[Alpha] - Flat insight, ignoring.")
                return []
            else:
                insight = Insight.Price(algorithm.Symbol("SPY"), timedelta(days = 1), direction)
    ...
    def getAlpha(self, algorithm):
        stock = Alphas(self.dataframe, algorithm)
        self.dataframe['alpha001']=stock.alpha001()
        self.dataframe['alpha002']=stock.alpha002()
        self.dataframe['alpha003']=stock.alpha003()
        self.dataframe['alpha004']=stock.alpha004()
        self.dataframe['alpha005']=stock.alpha005()
        self.dataframe['alpha006']=stock.alpha006()
        self.dataframe['alpha007']=stock.alpha007()
        self.dataframe['alpha008']=stock.alpha008()
        self.dataframe['alpha009']=stock.alpha009()
        self.dataframe['alpha010']=stock.alpha010()
        self.dataframe['alpha011']=stock.alpha011()
        self.dataframe['alpha012']=stock.alpha012()
        self.dataframe['alpha013']=stock.alpha013()
        self.dataframe['alpha014']=stock.alpha014()
        self.dataframe['alpha015']=stock.alpha015()
        self.dataframe['alpha016']=stock.alpha016()
        self.dataframe['alpha017']=stock.alpha017()
        self.dataframe['alpha018']=stock.alpha018()
        self.dataframe['alpha019']=stock.alpha019()
        self.dataframe['alpha020']=stock.alpha020()
        self.dataframe['alpha021']=stock.alpha021()
        self.dataframe['alpha022']=stock.alpha022()
        self.dataframe['alpha023']=stock.alpha023()
        self.dataframe['alpha024']=stock.alpha024()
        self.dataframe['alpha025']=stock.alpha025()
        self.dataframe['alpha026']=stock.alpha026()
        self.dataframe['alpha027']=stock.alpha027()
        self.dataframe['alpha028']=stock.alpha028()
        self.dataframe['alpha029']=stock.alpha029()
        self.dataframe['alpha030']=stock.alpha030()
        self.dataframe['alpha031']=stock.alpha031()
        self.dataframe['alpha032']=stock.alpha032()
        self.dataframe['alpha033']=stock.alpha033()
        self.dataframe['alpha034']=stock.alpha034()
        self.dataframe['alpha035']=stock.alpha035()
        self.dataframe['alpha036']=stock.alpha036()
        self.dataframe['alpha037']=stock.alpha037()
        self.dataframe['alpha038']=stock.alpha038()
        self.dataframe['alpha039']=stock.alpha039()
        self.dataframe['alpha040']=stock.alpha040()
        self.dataframe['alpha041']=stock.alpha041()
        self.dataframe['alpha042']=stock.alpha042()
        self.dataframe['alpha043']=stock.alpha043()
        self.dataframe['alpha044']=stock.alpha044()
        self.dataframe['alpha045']=stock.alpha045()
        self.dataframe['alpha046']=stock.alpha046()
        self.dataframe['alpha047']=stock.alpha047()
        self.dataframe['alpha049']=stock.alpha049()
        self.dataframe['alpha050']=stock.alpha050()
        self.dataframe['alpha051']=stock.alpha051()
        self.dataframe['alpha052']=stock.alpha052()
        self.dataframe['alpha053']=stock.alpha053()
        self.dataframe['alpha054']=stock.alpha054()
        self.dataframe['alpha055']=stock.alpha055()
        self.dataframe['alpha057']=stock.alpha057()
        self.dataframe['alpha060']=stock.alpha060()
        self.dataframe['alpha061']=stock.alpha061()
        self.dataframe['alpha062']=stock.alpha062()
        self.dataframe['alpha064']=stock.alpha064()
        self.dataframe['alpha065']=stock.alpha065()
        self.dataframe['alpha066']=stock.alpha066()
        self.dataframe['alpha068']=stock.alpha068()
        self.dataframe['alpha071']=stock.alpha071()
        self.dataframe['alpha072']=stock.alpha072()
        self.dataframe['alpha073']=stock.alpha073()
        self.dataframe['alpha074']=stock.alpha074()
        self.dataframe['alpha075']=stock.alpha075()
        self.dataframe['alpha077']=stock.alpha077()
        self.dataframe['alpha078']=stock.alpha078()
        self.dataframe['alpha081']=stock.alpha081()
        self.dataframe['alpha083']=stock.alpha083()
        self.dataframe['alpha084']=stock.alpha084()
        self.dataframe['alpha085']=stock.alpha085()
        self.dataframe['alpha086']=stock.alpha086()
        self.dataframe['alpha088']=stock.alpha088()
        self.dataframe['alpha092']=stock.alpha092()
        self.dataframe['alpha094']=stock.alpha094()
        self.dataframe['alpha095']=stock.alpha095()
        self.dataframe['alpha096']=stock.alpha096()
        self.dataframe['alpha098']=stock.alpha098()
        self.dataframe['alpha099']=stock.alpha099()
        self.dataframe['alpha101']=stock.alpha101()  
        return

class Alphas(object):
    def __init__(self, df_data, algorithm):
        ...
        self.returns = df_data['Simple Return']
        self.vwap = (df_data['close']*1000)/(df_data['volume']*100+1) 
    ...
    def alpha003(self):
        df = -1 * rank(self.open).corr(rank(self.volume))
        return df
